...
6. Do not stage files, create commits, push branches, open pull requests, or use the GitHub CLI. Another workflow step handles all repository publishing after you finish.
